        ...
        <nav className="space-y-1 flex-1">
          ...
          {role === "manager" && (
            <div className="space-y-0 ml-2 border-l-2 border-gray-100 pl-3">
              <Link href="/attendance?tab=me" className="block rounded-md px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-100">My Attendance</Link>
              <Link href="/attendance?tab=team" className="block rounded-md px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-100">Team Attendance</Link>
            </div>
          )}
